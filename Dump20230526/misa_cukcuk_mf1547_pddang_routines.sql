...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_Conversionunit_Delete`(IN p_ConversionUnitId char(36))
BEGIN
  DELETE
    FROM conversionunit
...
/*!50003 DROP PROCEDURE IF EXISTS `Proc_Conversionunit_DeleteMultiple` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_Conversionunit_DeleteMultiple`(IN p_MulitipleID text)
BEGIN

  IF IFNULL(p_MulitipleID, '') = '' THEN
  ...
  SET @deleteManyQuery = CONCAT('DELETE FROM conversionunit WHERE ConversionUnitId IN ', p_MulitipleID);



  PREPARE deleteMultipleQuery FROM @deleteManyQuery;

  EXECUTE deleteMultipleQuery;

  SELECT

    ROW_COUNT();

  DEALLOCATE PREPARE deleteMultipleQuery;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Proc_Conversionunit_GetListByID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_Conversionunit_GetListByID`(IN p_MaterialID varchar(255))
BEGIN
  SELECT * FROM conversionunit c WHERE c.MaterialId = p_MaterialID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_Conversionunit_Insert`(IN p_ConversionUnitId char(36), IN p_MaterialId char(36), IN p_UnitId char(36), IN p_Calculation smallint, IN p_ConversionRate double, IN p_CreatedBy varchar(255), IN p_CreatedDate datetime, IN p_ModifiedBy varchar(255), IN p_ModifiedDate datetime)
BEGIN

  INSERT INTO conversionunit (ConversionUnitId, MaterialId, UnitId, ConversionRate, Calculation, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate)
    VALUES (p_ConversionUnitId, p_MaterialId, p_UnitId, p_ConversionRate, p_Calculation, 'DangPD', NOW(), 'DangPD', NOW());
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_Conversionunit_Update`(IN p_ConversionUnitId char(36), IN p_MaterialId char(36), IN p_UnitId char(36), IN p_Calculation smallint, IN p_ConversionRate double, IN p_CreatedBy varchar(255), IN p_CreatedDate datetime, IN p_ModifiedBy varchar(255), IN p_ModifiedDate datetime)
BEGIN

  UPDATE conversionunit c
  SET ConversionUnitId = p_ConversionUnitId,
      MaterialId = p_MaterialId,
      UnitId = p_UnitId,
      ConversionRate = p_Calculation,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Proc_Material_GetByCode` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_Material_GetByCode`(IN p_MaterialCode VARCHAR(255))
BEGIN
  SELECT * FROM material m WHERE m.MaterialCode = p_MaterialCode;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
  ...
  SELECT * FROM material m WHERE m.MaterialId IN ('1ce95400-787b-1833-b5f6-423b4e874d0f',"22e1c5f6-3888-6d33-6435-0028ed526dd0","18d2ec1b-61c5-1896-2ec2-579daad24557");
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
